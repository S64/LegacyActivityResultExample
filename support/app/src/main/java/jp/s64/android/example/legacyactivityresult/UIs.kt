package jp.s64.android.example.legacyactivityresult
...
class SupportEntrypoint : android.support.v7.app.AppCompatActivity() {
...
class SupportLauncher : android.support.v4.app.Fragment() {
